...
var ArrowContainer = function (_a) {
    ...
    return (React.createElement("div", { onClick: function (e) { e.stopPropagation(); }, style: __assign({ pointerEvents: 'none', paddingLeft: position === 'right' ? arrowSize : 0, paddingTop: position === 'bottom' ? arrowSize : 0, paddingBottom: position === 'top' ? arrowSize : 0, paddingRight: position === 'left' ? arrowSize : 0 }, style) },
        React.createElement("div", { onClick: function (e) { e.stopPropagation(); }, style: __assign(__assign({ pointerEvents: 'none', position: 'absolute' }, (function () {
